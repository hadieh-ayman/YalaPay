...
async function deleteInvoice(invoiceNo) {
    await repo.deleteInvoice(parseInt(invoiceNo));
    await showInvoiceData();
}

async function updateInvoice(invoiceNo) {
    const invoice = await repo.getInvoice(parseInt(invoiceNo));
...
async function searchInvoices(e) {
    ...
    const invoice = await repo.getInvoice(parseInt(searchInput.invoiceNo));
    invoiceTable.innerHTML = `
    <tr class="table-headings">
      <th>Invoice No.</th>
      <th>Customer ID</th>
